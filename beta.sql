...
INSERT INTO `account_data` VALUES (1,'nemanjamudrinski@gmail.com','{bcrypt}$2a$10$x0rV6EjhNwLtsNtn/3aX1.DjryDFD0S5tcXHnaicUMyLCkHMnLYhG','admin'),(2,'gordanajatic@gmail.com','{bcrypt}$2a$10$x0rV6EjhNwLtsNtn/3aX1.DjryDFD0S5tcXHnaicUMyLCkHMnLYhG','gordana.jatic'),(3,'vanjacveticanin@gmail.com','{bcrypt}$2a$10$VWlU5IIjFTCwM17egjuAUePRngIxzxf3YiEErd6pxZYovIgkSEJuS','vanja.cveticanin'),(4,'majapjevac@gmail.com','{bcrypt}$2a$10$RZB/GYNpnx.EcCf.T5KNpOXiuLKx77t8Hi1AaV1lkji7JtfJFQSHy','maja.pjevac'),(5,'milicaacanski@gmail.com','{bcrypt}$2a$10$bCUGOHr20j1mr3fL6WBzHuQ5N35H0iDfvdUOEbg.nWqS15ogbDSHu','milica.acanski'),(6,'marinacuk@gmail.com','{bcrypt}$2a$10$.iV/Wbbu13T7VLWaR8dHPuX/bGhOUh0z1.gHMbYNr0TNajMMCq5Rq','marina.cuk'),(7,'isidoraivanisevic@gmail.com','{bcrypt}$2a$10$wZHcGaBXDSbPGENgd.G78O4w9ynXBqQyKHVpX/0JN.skLhN06j7Bm','isidora.ivanisevic'),(8,'jelenadrljaca@gmail.com','{bcrypt}$2a$10$EB2fw7icd21vgduX5i99KO1JVNJSiQFOpMf./OArT6UXEdOK/R5ie','jelena.drljaca');
...
INSERT INTO `client` VALUES (1,3,2),(2,4,3),(3,5,4),(4,6,5),(5,7,6),(6,8,7);
...
INSERT INTO `personal_data` VALUES (1,'Gordana','Jatic','0645236985','images/profile_images/owner_gordana.jatic.jpg'),(2,'Vanja','Cveticanin','0653269546','images/profile_images/client_vanja.cveticanin.jpg'),(3,'Maja','Pjevac','062599808','images/profile_images/client_maja.pjevac.png'),(4,'Milica','Acanski','0657832456','images/profile_images/client_milica.acanski.png'),(5,'Marina','Cuk','0546789090',NULL),(6,'Isidora','Ivanisevic','0634567909','images/profile_images/client_isidora.ivanisevic.JPG'),(7,'Jelena','Drljaca','0623416309','images/profile_images/client_jelena.drljaca.jpg');
...
INSERT INTO `user_permission` VALUES (1,1,1),(2,2,2),(3,3,4),(4,4,4),(5,5,4),(6,6,4),(7,7,4),(8,8,4);
...
-- Dump completed on 2019-10-03 15:50:03
